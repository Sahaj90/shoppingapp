...
import 'package:shopingapp/profile/order_place_details.dart';
import 'package:shopingapp/profile/order_status.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              orderStatus(
                  color: Colors.yellow ,icon: Icons.delivery_dining, title: 'On Delivery', showDone: data['order_on_delivery']
              ),
              orderStatus(
                  color: Colors.green,icon: Icons.done_all_rounded, title: 'Delivered', showDone: data['order_delivered']
              ),
              const Divider(),
              10.heightBox,
              Column(
